...
from src.embedding.embeddingclient import EmbeddingClient, EmbeddingsHuggingFace
from src.vectordb.dbinstance import ChromaCollectionCreator
from src.quiz_generator.quizgenerator import QuizGenerator
from src.quiz_manager.quizmanager import QuizManager
    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                embed_client = EmbeddingsHuggingFace(model_name="../../artifacts/embeddings/models--sentence-transformers--all-mpnet-base-v2/snapshots/84f2bcc00d77236f9e89c8a360a00fb1139bf47d") 
            
                chroma_creator = ChromaCollectionCreator(processor, embed_client.emembeddings,persist_directory="../../artifacts/chroma_db")
        ...
        with st.container():
            ...
            quiz_manager = QuizManager(questions=st.session_state['question_bank'])
