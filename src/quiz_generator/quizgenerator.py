...
class QuizGenerator:
    def __init__(self, topic=None, num_questions=1, vectorstore=None):
        ...
        self.system_template = """
            ...
            1. Generate a multiple choice question based on the topic provided and context"
            2. Question must have a key "question"
            3. Provide 4 multiple choice answers to the question as a list of key-value pairs "choices"
            4. Provide the correct answer for the question from the list of answers as key "answer"
            5. Provide an explanation as to why the answer is correct as key "explanation"
    ...
    def generate_question_with_vectorstore(self):
        ...
        retriever = self.vectorstore.db.as_retriever(search_type = "mmr",kwargs={"k":4,"lambda_mult":1})
        ...
        for j in range(self.num_questions):
            ...
            for i in range(retry):
                ...
                try:
                    ...
                    print("Broken Question",question_str)
